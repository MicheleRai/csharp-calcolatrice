...
Console.WriteLine(CalcoliHelper.Somma(3, 5));
Console.WriteLine(CalcoliHelper.Somma(3.5, 5.5));
Console.WriteLine(CalcoliHelper.Differenza(3, 5));
Console.WriteLine(CalcoliHelper.Differenza(3.5, 5.5));
Console.WriteLine(CalcoliHelper.Moltiplicazione(3, 5));
Console.WriteLine(CalcoliHelper.Moltiplicazione(3.5, 5.5));
Console.WriteLine(CalcoliHelper.ValoreAssoluto(-3));
Console.WriteLine(CalcoliHelper.ValoreAssoluto(-3.5));
Console.WriteLine(CalcoliHelper.MinimoTra(3, 5));
